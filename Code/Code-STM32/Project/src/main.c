...
uint16_t data = 0, old_data = 0,check = 0;
short led1=0, led2=0, led3=0, led4=0;
short led1sta=0, led2sta=0, led3sta=0, led4sta=0;
uint8_t timesend;
/*Declare Struct*/
...
void readadc()
{
	...
	if (ADC3ConvertedValue[3] > 255)
		...
		led4sta = 0;
//	led1sta = ADC3ConvertedValue[0];
//	led2sta = ADC3ConvertedValue[1];
//	led3sta = ADC3ConvertedValue[2];
//	led4sta = ADC3ConvertedValue[3];
}
