				...
				<div class="slider">
					...
					<div class="layerslider height-500" style="width:100%;">
						...
						<div class="ls-slide" data-ls="slidedelay:8000;transition2d:21,105;">
							...
							<!-- background image -->
							<img src="demo_files/images/layerslider/slide-b-bg.jpg" class="ls-bg" alt="Slide background"/>
							...
							<img class="ls-l" data-ls="offsetxin:-100;durationin:2000;delayin:1500;offsetxout:-100;durationout:1000;parallaxlevel:-2;" style="top:30%;left:50%;width:120%;height:auto;white-space: nowrap;" src="demo_files/images/layerslider/slide-b-1.png" alt="">
							<img class="ls-l" data-ls="offsetxin:50;durationin:2000;delayin:1500;offsetxout:50;durationout:1000;parallaxlevel:1;" style="top:3px;left:137px;white-space: nowrap;" src="demo_files/images/layerslider/slide-b-2.png" alt="">
							<img class="ls-l" data-ls="offsetxin:100;durationin:2000;delayin:1500;offsetxout:100;durationout:1000;parallaxlevel:3;" style="top:203px;left:383px;white-space: nowrap;" src="demo_files/images/layerslider/slide-b-3.png" alt="">
							<img class="ls-l" data-ls="offsetxin:150;durationin:2000;delayin:1500;offsetxout:150;durationout:1000;parallaxlevel:5;" style="top:206px;left:486px;white-space: nowrap;" src="demo_files/images/layerslider/slide-b-4.png" alt="">
							<img class="ls-l" data-ls="offsetxin:200;durationin:2000;delayin:1500;offsetxout:200;durationout:1000;parallaxlevel:7;" style="top:171px;left:559px;white-space: nowrap;" src="demo_files/images/layerslider/slide-b-5.png" alt="">
							...
							<img class="ls-l" style="top:45%;left:585px;white-space: nowrap;" data-ls="offsetxin:0;durationin:1500;delayin:1500;rotateyin:90;transformoriginin:right 50% 0;offsetxout:0;durationout:1500;showuntil:1000;rotateyout:-90;transformoriginout:right 50% 0;" src="demo_files/images/layerslider/mouse.png" alt="">
						...
						<div class="ls-slide" data-ls="slidedelay:8000;transition2d:75,79;">
							...
							<!-- background image -->
							<img src="demo_files/images/layerslider/bg.jpg" class="ls-bg" alt="Slide background"/>
							...
							<img class="ls-l" data-ls="
								...
								scalexout:0.8;
								scaleyout:0.8;" 
								style="top:40px;left:65%;white-space: nowrap;" src="demo_files/images/desktop.png" alt="">
						...
						<div class="ls-slide" data-ls="slidedelay:8000;transition2d:21,105;timeshift:-1000;">
							...
							<!-- background -->
							<img src="demo_files/images/blue.jpg" class="ls-bg" alt="Slide background"/>
							...
							<img class="ls-l" data-ls="
								...
								scalexout:2;
								scaleyout:2;" 
								style="top:20px;left:50%;white-space: nowrap;" src="demo_files/images/layerslider/circle.png" alt="">
							<img class="ls-l" data-ls="
								offsetxin:0;
								durationin:1500;
								delayin:4000;
							...
							<img class="ls-l" data-ls="
								...
								scalexout:0.8;
								scaleyout:0.8;" 
								style="top:80px;left:50%;white-space: nowrap;" src="demo_files/images/layerslider/ls5box.png" alt="">
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<header class="margin-bottom-40">
								<h1 class="weight-300">Welcome to our Project</h1>
								<h2 class="weight-300 letter-spacing-1 size-13"><span>Control Device with Iots</span></h2>
							</header>

							<p>
								This is a joint project between Iots and 32bit Arm microcontroller, namely STM32F407. Along with user identification through raspberry and opencv. The group's ultimate goal is to create a product that helps people feel more secure when they want to protect their home.
							</p>
							
							<p>
								If you feel this project can help you. Do not hesitate to contact us
							</p>
							<hr />
